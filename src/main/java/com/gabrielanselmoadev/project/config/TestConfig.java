...
import com.gabrielanselmoadev.project.entities.*;
import com.gabrielanselmoadev.project.entities.enums.OrderStatus;
import com.gabrielanselmoadev.project.repositories.*;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2023-01-14T14:50:03Z"), OrderStatus.WAITING_PAYMENT, u2);
